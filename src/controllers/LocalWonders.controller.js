...
const getDataFrontend = async (req, res) => {
  try {
    const data = await LocalWonders.find();
...
const getData = async (req, res) => {
  try {
    ...
    const data = await LocalWonders.find(query).skip(skip).limit(limit);
    const totalDataCount = await LocalWonders.countDocuments(query);
...
const addData = async (req, res) => {
  try {
    ...
    const newData = new LocalWonders({
      type,
      title,
      description,
...
const updateData = async (req, res) => {
  try {
    ...
    const data = await LocalWonders.findById(id);
    ...
    await LocalWonders.findByIdAndUpdate(id, updatedFields, {
      new: true,
    });
...
const deleteData = async (req, res) => {
  try {
    ...
    await LocalWonders.findByIdAndDelete(id);
