...
const getDataFrontend = async (req, res) => {
  try {
    const data = await RVExperience.find();
...
const getData = async (req, res) => {
  try {
    ...
    const data = await RVExperience.find(query).skip(skip).limit(limit);
    const totalDataCount = await RVExperience.countDocuments(query);
...
const addData = async (req, res) => {
  try {
    ...
    const newData = new RVExperience({
      title,
      description,
...
const updateData = async (req, res) => {
  try {
    ...
    const data = await RVExperience.findById(id);
    ...
    await RVExperience.findByIdAndUpdate(id, updatedFields, {
      new: true,
    });
...
const deleteData = async (req, res) => {
  try {
    ...
    await RVExperience.findByIdAndDelete(id);
