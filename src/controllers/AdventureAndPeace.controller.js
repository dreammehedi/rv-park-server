...
const getDataFrontend = async (req, res) => {
  try {
    const data = await AdventureAndPeace.find();
...
const getData = async (req, res) => {
  try {
    ...
    const data = await AdventureAndPeace.find(query).skip(skip).limit(limit);
    const totalDataCount = await AdventureAndPeace.countDocuments(query);
...
const addData = async (req, res) => {
  try {
    ...
    const newData = new AdventureAndPeace({
      title,
      description,
      lat,
      long,
...
const updateData = async (req, res) => {
  try {
    ...
    const data = await AdventureAndPeace.findById(id);
    ...
    await AdventureAndPeace.findByIdAndUpdate(id, updatedFields, {
      new: true,
    });
...
const deleteData = async (req, res) => {
  try {
    ...
    await AdventureAndPeace.findByIdAndDelete(id);
